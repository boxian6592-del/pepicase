        ...
        <div class="d-flex align-items-center justify-content-center">
            <form action="">
                ...
                <table>
                    ...
                    <tr >
                        <td>
                            <a style=" color: #1F3E97" href="/pepicase/resetpassword1.php">Forgot your password?</a>
                        </td>
                        <td style="text-align:right;">
                            <a style="color: #1F3E97" href="">Create an account</a>
                        </td>
                    </tr>
                </table>
                ...
                <div class="d-flex justify-content-between">
                    <a href="https://www.facebook.com/login">
                        <button type="button" class="button">
                            <img src="/pepicase/pics/Facebook_icon.svg" alt="Your Image">Facebook</button>
                    </a>
                    <a href="https://www.facebook.com/login">
                        <button type="button" class="button">
                            <img src="/pepicase/pics/Google_Icons-09-512.webp" alt="Your Image">Gun Gồ</button>
                    </a> 
                </div>
                </div>
            </form>
