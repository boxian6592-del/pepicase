    ...
    <div class="container">
        <div class = "d-flex flex-column justify-content-center align-items-center">
            <div class="footer-a lexend" style="font-size: 20px;line-height: 35px; margin-top: 10px">
                ...
                <a style="margin-left: 5px"> pepicase@gmail.com</a><br>
                <a href=""><img src="/pepicase/public/pics/call.svg" alt="call-icon"></a>
                <a style="margin-left: 5px"> (028) 99999999</a>
            </div>
        </div>
            ...
            <div class = "bottom-nav lexend" style = "margin-left: 90px; padding-bottom: 20px; font-size: 20px;">
